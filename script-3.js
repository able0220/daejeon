...
async function init() {
    const modelURL = 'https://teachablemachine.withgoogle.com/models/HqciWKv4Y/model.json';
    const metadataURL = 'https://teachablemachine.withgoogle.com/models/HqciWKv4Y/metadata.json';
