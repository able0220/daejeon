...
async function init() {
    const modelURL = 'https://teachablemachine.withgoogle.com/models/EtXtFaIVj/model.json';
    const metadataURL = 'https://teachablemachine.withgoogle.com/models/EtXtFaIVj/metadata.json';
