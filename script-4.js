...
async function init() {
    const modelURL = 'https://teachablemachine.withgoogle.com/models/13jY6sU6E/model.json';
    const metadataURL = 'https://teachablemachine.withgoogle.com/models/13jY6sU6E/metadata.json';
