...
async function init() {
    const modelURL = 'https://teachablemachine.withgoogle.com/models/DOJFtYfGg/model.json';
    const metadataURL = 'https://teachablemachine.withgoogle.com/models/DOJFtYfGg/metadata.json';
