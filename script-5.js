...
async function init() {
    const modelURL = 'https://teachablemachine.withgoogle.com/models/iReO7WfuL/model.json';
    const metadataURL = 'https://teachablemachine.withgoogle.com/models/iReO7WfuL/metadata.json';
